  ...
  return (
    <>
      <div className='relative w-full h-[450px] sm:h-[620px] bg-[#f3f3f9] border-[5px] border-white rounded-tl-[20px] rounded-tr-[5px] rounded-bl-[20px] rounded-br-[5px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.10)] outline-[5px] outline-offset-[-5px] outline-white overflow-hidden'>
        <div className='inline-flex flex-col justify-start items-start gap-4 xl:gap-7 md:p-10 p-6'>
        ...
        {showVideo && (
          <>
            ...
            {/* Video with play button - clickable */}
            <button
              onClick={handleVideoClick}
              className='w-32 sm:w-48 h-56 sm:h-80 left-[50%] md:left-[25%] lg:left-[20%] xl:left-[25%] top-[58%] sm:top-[50%] lg:top-[55%] xl:top-80 -translate-x-1/2 md:translate-x-0 lg:translate-x-0 absolute shadow-[0px_4px_20px_0px_rgba(0,0,0,0.25)] rounded-[20px] cursor-pointer hover:scale-105 transition-transform'>
              <video
