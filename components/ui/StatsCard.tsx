...
export default function StatsCard({ imageSrc, imageAlt, title, description }: StatsCardProps) {
  return (
    <div className='relative rounded-[40px] shadow-[0_4px_4px_rgba(0,0,0,0.10)] overflow-hidden p-2 bg-linear-to-b from-[#FFFFFF] to-[#F3F3F9] flex flex-col gap-6 h-[337px]'>
      {/* Top Image Section */}
      <div className='relative w-full h-[195px] overflow-hidden bg-gray-100 rounded-t-[32px] rounded-tr-[32px]'>
        <Image
          src={imageSrc}
          alt={imageAlt}
          fill
      ...
      {/* Content */}
      <div className='flex flex-col gap-6 pb-8 px-4 rounded-[32px]'>
