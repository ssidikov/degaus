      ...
      <div
        ...
        <div className='flex flex-col h-full pt-24 px-6 pb-8'>
          ...
          <div className='flex flex-col gap-4 mt-auto'>
            ...
            <button
              aria-label='Try for free'
              className='w-full h-[45px] rounded-[10px] px-4 py-2 pb-[10px] text-lg font-bold text-white bg-white/20 shadow-[0px_4px_15px_0px_rgba(255,255,255,0.15),inset_0px_-4px_4px_0px_rgba(0,0,0,0.3),inset_0px_4px_4px_0px_rgba(255,255,255,0.3)] hover:bg-white/30 transition whitespace-nowrap tracking-[-0.4px]'>
              Try for free
            </button>
          </div>
        </div>
